$(document).ready(function() {
  ...
  function updateGoogleSheet(ad_study_id) {
    var all_sheets = ['1yahQgPlrwcTgb5uADyTIt6Ahyzsrks7vPDSzTtF8BoY', 
                      '1R8GFHVlpQYVsyZonAPPkjlb-s9j-yoz1-443Rkh1VvQ', 
                      '1rG0arZhW_JczujYYNfhol1TzvswLjrNDcAbAGbhROVo', 
                      '1RlPLjb6dDylD5HPpMa_iOdTI6bD_xgzumg_LY5BrR-g', 
                      '1rPmLfwj4yjcuBuiWKADyGdjYaaUypQUbWZojcnF6xoc', 
                      '1L-TLXeCOfuwZbGaIPrPVpu8crYuc3OsAPuK-t6nj0M4', 
                      '1NO9W4oo6g6tGHUWd3QQuXrp07cYNklDmVW4S92pgbW8',
  ...
  function submitTest(formData) {
    ...
    $.ajax({
      url: "https://graph.facebook.com/v2.11/" + fb_biz_id + "/ad_studies",
      type: 'POST',
      dataType: 'json',
      data: formData,
